...
ATOMIC_ACTION_SIGNITURES_noxml = {
    ...
    WAIT: {
        "arguments": ["time"],
        "description": lambda info: "Wait for a specified number of seconds. Useful for waiting for page loading, animations, or network requests to complete. Usage Example: {\"action\": \"wait\", \"time\": 3}"
    }
}
