...
3. Click the search box to activate search box.
4. type the content that the user wants to search for.  
5. click '搜索', do not click the '智搜' toggle switch. 
6. click the '智搜' tab botton on the search results page. do not click'问智搜' botton. 
7. click the '继续问智搜' botton. 
